...
final class ProfileViewController: UIViewController {
  ...
  private let photoDataView = ProfileDateView(title: "게시물", count: 123)
  private let followerDataView = ProfileDateView(title: "팔로워", count: 2_000)
  private let followingDataView = ProfileDateView(title: "팔로잉", count: 1)
